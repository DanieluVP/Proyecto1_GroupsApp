  ...
  return (
    <div className="space-y-1">
      {members.map((m) => {
        ...
        return (
          <div key={m.userId} className="flex items-center gap-2 px-2 py-1.5 rounded-lg hover:bg-gray-700 transition-colors">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className={`text-[11px] font-medium ${online ? 'text-green-400' : 'text-gray-500'}`}>
